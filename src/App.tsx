...
import PsychometricServices from "./pages/PsychometricServices";
import CAP360TestimonialsManagement from "./pages/CAP360TestimonialsManagement";
            ...
            <div className="min-h-screen flex flex-col">
              ...
              <main className="flex-1">
                <Routes>
                  ...
                  <Route path="/psychometric-services" element={<PsychometricServices />} />
                  ...
                  />
                  <Route 
                    path="/admin/cap360-testimonials" 
                    element={
                      <ProtectedRoute>
                        <CAP360TestimonialsManagement />
                      </ProtectedRoute>
                    } 
                  />
                  <Route 
