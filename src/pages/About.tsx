...
import SaurabhNanda from "@/assets/SaurabhNanda.png";
import Harpreet from "@/assets/Harpreet.png";
  ...
  const team = [
    {
      ...
      {
      name: "Saurabh Nanda",
      role: " Career Coach & International Youth Mentor  , Advisor CAP360",
      credentials: "NIT Jalandhar || Behavioural Science Expert || TEDx Speaker || Karamveer Chakra Awardee",
      image: SaurabhNanda,
      bio: "Bridges behavioural science with career transformation. Supporting 2000+ professionals across 35+ countries, he goes beyond traditional coaching to address the psychological roots of career challenges—from burnout and imposter syndrome to transitions and anxiety. A former IT professional turned career psychologist, two-time TEDx speaker, and Karamveer Chakra Awardee, Saurabh combines evidence-based frameworks with AI-driven insights through CAP360. He helps clients understand not just what to do, but why they do it. His approach: sustainable success begins with self-understanding, honoring both professional ambition and mental well-being.",
      specialties: [
        "Career Psychology",
        "Leadership Coaching ",
        "Leadership Development",
      ...
      role: " Advisor, CAP360",
      credentials: "IIM Ahmedabad || CAT 99.99% || NIT Jalandhar || Ex-Amazon || Product & Strategy Specialist", 
      image: Harpreet,
      bio: "A results-driven product and strategy professional with 7+ years of experience across Amazon India and high-growth startups. A graduate of IIM Ahmedabad, he has led strategic programs in product management, category leadership, and operations, managing brands like Apple within Amazon’s ecosystem. At CAP360, Harpreet mentors professionals transitioning into product, strategy, and leadership roles, helping them scale through data-driven decision-making, analytical excellence, and business innovation.",
      specialties: [
        "Product Strategy",
        "Career Transitions",
        "Leadership Development",
    ...
    },
    {
      ...
      credentials: "10+ Years Experience || MBA || HR Specialist",
      image: Bakshish1,
