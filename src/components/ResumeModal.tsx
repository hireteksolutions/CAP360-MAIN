...
const ResumeModal = ({ children }: ResumeAuditModalProps) => {
  ...
  const handleSubmit = async (data: FormData) => {
    ...
    try {
      ...
      toast({
        ...
        description: "We'll send your resume within 24-48 hours.",
      });
      ...
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-2xl text-heading-teal">
            Strategize My Career
          </DialogTitle>
          <DialogDescription>
            Upload your details and receive a tailored career strategy designed to position you for the right roles.
          </DialogDescription>
        </DialogHeader>
            ...
            <ul className="space-y-1 text-sm text-gray-600">
              <li className="flex items-center">
                <CheckCircle className="h-4 w-4 text-green-500 mr-2" />
                 Strategic ATS & recruiter-readiness analysis
              </li>
              <li className="flex items-center">
                <CheckCircle className="h-4 w-4 text-green-500 mr-2" />
                Role-specific positioning and content strategy
              </li>
              <li className="flex items-center">
                <CheckCircle className="h-4 w-4 text-green-500 mr-2" />
                 Industry-aligned career insights and recommendations              </li>
              <li className="flex items-center">
                <CheckCircle className="h-4 w-4 text-green-500 mr-2" />
                Free follow-up strategy consultation
              </li>
            </ul>
          </div>
